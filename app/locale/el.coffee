...
#  subscribe_for_gems:
#    prompt_title: "Όχι αρκετά πετράδια!"
#    prompt_body: "Γίνε συνδρομητής Premium για να πάρεις πετράδια και να έχεις πρόσβαση σε ακόμα περισσότερα επίπεδα!"
...
#    hoc_blurb1: "Δοκίμασε το ..."
#    hoc_blurb2: "Προγραμμάτισε, Παίξε, Μοιράσου"
#    hoc_blurb3: "δραστηριότητα! κατασκεύασε 4 διαφορετικά minigames για να μάθεις τα βασικά της δημιουργίας παιχνιδιών, και φτιάξε το δικό σου"
...
#  apcsp:
#    syllabus: "AP CS Ύλη Βασικών Αρχών"
#    syllabus_description: "Χρησιμοποιήστε αυτόν τον πόρο για να σχεδιάσετε το πρόγραμμα σπουδών CodeCombat για την κατηγορία AP Αρχές Πληροφορικής"
#    computational_thinking_practices: "Πρακτικές Υπολογιστικής σκέψης"
#    learning_objectives: "Στόχοι μάθησης"
#    curricular_requirements: "Απαιτήσεις διδακτέας ύλης"
#    unit_1: "Μονάδα 1: Δημιουργική τεχνολογία"
#    unit_1_activity_1: "Ενότητα 1 Δραστηριότητα: Επισκόπηση χρηστικότητας της τεχνολογίας"
#    unit_2: "Μονάδα 2: Υπολογιστική Σκέψη"
#    unit_2_activity_1: "Ενότητα 2 Δραστηριότητα: Δυαδικές ακολουθίες"
#    unit_2_activity_2: "Ενότητα 2 Δραστηριότητα: Σχέδιο μαθήματος πληροφορικής"
#    unit_3: "Μονάδα 3: Αλγόριθμοι"
#    unit_3_activity_1: "Ενότητα 3 Δραστηριότητα: Αλγόριθμοι - Σχέδιο για Οτοστοπ"
#    unit_3_activity_2: "Μονάδα 3 Δραστηριότητα: Προσομοίωση - Θύτης και θύμα"
#    unit_3_activity_3: "Ενότητα 3 Δραστηριότητα: Αλγόριθμοι - Σχεδιασμός ζεύγους και προγραμματισμός "
#    unit_4: "Μονάδα 4: Προγραμματισμός"
#    unit_4_activity_1: "Ενότητα 4 Δραστηριότητα: Αφαιρέσεις"
#    unit_4_activity_2: "Ενότητα 4 Δραστηριότητα: Αναζήτηση & Ταξινόμηση"
#    unit_4_activity_3: "Ενότητα 4 Δραστηριότητα: Επαναδιαμόρφωση" 
#    unit_5: "Μονάδα 5: Το Διαδίκτυο"
#    unit_5_activity_1: "Ενότητα 5 Δραστηριότητα: Πώς λειτουργεί το Διαδίκτυο "
#    unit_5_activity_2: "Ενότητα 5 Δραστηριότητα: Προσομοιωτής Διαδικτύου "
#    unit_5_activity_3: "Ενότητα 5 Δραστηριότητα: Προσομοίωση δωματίου συνομιλίας"
#    unit_5_activity_4: "Ενότητα 5 Δραστηριότητα: Διαδικτυακή Ασφάλεια "
#    unit_6: "Μονάδα 6: Δεδομένα"
#    unit_6_activity_1: "Ενότητα 6 Δραστηριότητα: Εισαγωγή στα δεδομένα"
#    unit_6_activity_2: "Ενότητα 6 Δραστηριότητα: Μεγάλα δεδομένα "
#    unit_6_activity_3: "Ενότητα 6 Δραστηριότητα: Απωλεστική και μη απωλεστική συμπίεση"
#    unit_7: "Μονάδα 7: Προσωπική και παγκόσμια επίδραση"
#    unit_7_activity_1: "Ενότητα 7 Δραστηριότητα: Ατομικές και παγκόσμιες επιπτώσεις"
#    unit_7_activity_2: "Ενότητα 7 Δραστηριότητα: Crowdsourcing"
#    unit_8: "Ενότητα 8: Εργασίες απόδοσης"
#    unit_8_description: "Προετοιμάστε τους μαθητές για την εργασία της Δημιουργίας φτιάχνοντας τα δικά τους παιχνίδια και εφαρμόζοντας βασικές έννοιες."
#    unit_8_activity_1: "Δημιουργία πρακτικής εργασίας 1: Ανάπτυξη παιχνιδιού 1"
#    unit_8_activity_2: "Δημιουργία πρακτικής εργασίας 1: Ανάπτυξη παιχνιδιού 2"
#    unit_8_activity_3: "Δημιουργία πρακτικής εργασίας 1: Ανάπτυξη παιχνιδιού 3"
#    unit_9: "Unit 9: AP Έλεγχος"
#    unit_10: "Unit 10: Post-AP"
#    unit_10_activity_1: "Ενότητα 10 Δραστηριότητα: Web Quiz"

#  parent_landing:
#    slogan_quote: "\"CodeCombat είναι πραγματικά διασκεδαστικό και μαθαίνετε πολλά.\""
#    quote_attr: "5th Grader, Oakland, CA"
#    refer_teacher: "Ανατρέξτε σε Δάσκαλο"
#    focus_quote: "Ξεκλειδώστε το μέλλον του παιδιού σας"
#    value_head1: "Ο πιο συναρπαστικός τρόπος για να μάθετε δακτυλογραφημένο κώδικα"
